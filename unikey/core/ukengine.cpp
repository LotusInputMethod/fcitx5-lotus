...
unsigned char    SpecialWesternChars[] = {0x80, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88, 0x89, 0x8A, 0x8B, 0x8C, 0x8E, 0x91,
                                          0x92, 0x93, 0x94, 0x95, 0x96, 0x97, 0x98, 0x99, 0x9A, 0x9B, 0x9C, 0x9E, 0x9F, 0x00};
...
VowelSeqInfo VSeqList[] = {{1, 1, 1, {vnl_a, vnl_nonVnChar, vnl_nonVnChar}, {vs_a, vs_nil, vs_nil}, -1, vs_ar, -1, vs_ab},
...
ConSeqInfo CSeqList[] = {{1, {vnl_b, vnl_nonVnChar, vnl_nonVnChar}, false},  {1, {vnl_c, vnl_nonVnChar, vnl_nonVnChar}, true},
                         {2, {vnl_c, vnl_h, vnl_nonVnChar}, true},           {1, {vnl_d, vnl_nonVnChar, vnl_nonVnChar}, false},
                         {1, {vnl_dd, vnl_nonVnChar, vnl_nonVnChar}, false}, {2, {vnl_d, vnl_z, vnl_nonVnChar}, false},
                         {1, {vnl_g, vnl_nonVnChar, vnl_nonVnChar}, false},  {2, {vnl_g, vnl_h, vnl_nonVnChar}, false},
                         {2, {vnl_g, vnl_i, vnl_nonVnChar}, false},          {3, {vnl_g, vnl_i, vnl_n}, false},
                         {1, {vnl_h, vnl_nonVnChar, vnl_nonVnChar}, false},  {1, {vnl_k, vnl_nonVnChar, vnl_nonVnChar}, false},
                         {2, {vnl_k, vnl_h, vnl_nonVnChar}, false},          {1, {vnl_l, vnl_nonVnChar, vnl_nonVnChar}, false},
                         {1, {vnl_m, vnl_nonVnChar, vnl_nonVnChar}, true},   {1, {vnl_n, vnl_nonVnChar, vnl_nonVnChar}, true},
                         {2, {vnl_n, vnl_g, vnl_nonVnChar}, true},           {3, {vnl_n, vnl_g, vnl_h}, false},
                         {2, {vnl_n, vnl_h, vnl_nonVnChar}, true},           {1, {vnl_p, vnl_nonVnChar, vnl_nonVnChar}, true},
                         {2, {vnl_p, vnl_h, vnl_nonVnChar}, false},          {1, {vnl_q, vnl_nonVnChar, vnl_nonVnChar}, false},
                         {2, {vnl_q, vnl_u, vnl_nonVnChar}, false},          {1, {vnl_r, vnl_nonVnChar, vnl_nonVnChar}, false},
                         {1, {vnl_s, vnl_nonVnChar, vnl_nonVnChar}, false},  {1, {vnl_t, vnl_nonVnChar, vnl_nonVnChar}, true},
                         {2, {vnl_t, vnl_h, vnl_nonVnChar}, false},          {2, {vnl_t, vnl_r, vnl_nonVnChar}, false},
                         {1, {vnl_v, vnl_nonVnChar, vnl_nonVnChar}, false},  {1, {vnl_x, vnl_nonVnChar, vnl_nonVnChar}, false}};
...
VCPair    VCPairList[] = {{vs_a, cs_c},    {vs_a, cs_ch},   {vs_a, cs_m},     {vs_a, cs_n},    {vs_a, cs_ng},   {vs_a, cs_nh},   {vs_a, cs_p},   {vs_a, cs_t},    {vs_ar, cs_c},
                          {vs_ar, cs_m},   {vs_ar, cs_n},   {vs_ar, cs_ng},   {vs_ar, cs_p},   {vs_ar, cs_t},   {vs_ab, cs_c},   {vs_ab, cs_m},  {vs_ab, cs_n},   {vs_ab, cs_ng},
                          {vs_ab, cs_p},   {vs_ab, cs_t},

                          {vs_e, cs_c},    {vs_e, cs_ch},   {vs_e, cs_m},     {vs_e, cs_n},    {vs_e, cs_ng},   {vs_e, cs_nh},   {vs_e, cs_p},   {vs_e, cs_t},    {vs_er, cs_c},
                          {vs_er, cs_ch},  {vs_er, cs_m},   {vs_er, cs_n},    {vs_er, cs_nh},  {vs_er, cs_p},   {vs_er, cs_t},

                          {vs_i, cs_c},    {vs_i, cs_ch},   {vs_i, cs_m},     {vs_i, cs_n},    {vs_i, cs_nh},   {vs_i, cs_p},    {vs_i, cs_t},

                          {vs_o, cs_c},    {vs_o, cs_m},    {vs_o, cs_n},     {vs_o, cs_ng},   {vs_o, cs_p},    {vs_o, cs_t},    {vs_or, cs_c},  {vs_or, cs_m},   {vs_or, cs_n},
                          {vs_or, cs_ng},  {vs_or, cs_p},   {vs_or, cs_t},    {vs_oh, cs_m},   {vs_oh, cs_n},   {vs_oh, cs_p},   {vs_oh, cs_t},

                          {vs_u, cs_c},    {vs_u, cs_m},    {vs_u, cs_n},     {vs_u, cs_ng},   {vs_u, cs_p},    {vs_u, cs_t},    {vs_uh, cs_c},  {vs_uh, cs_m},   {vs_uh, cs_n},
                          {vs_uh, cs_ng},  {vs_uh, cs_t},

                          {vs_y, cs_t},    {vs_ie, cs_c},   {vs_ie, cs_m},    {vs_ie, cs_n},   {vs_ie, cs_ng},  {vs_ie, cs_p},   {vs_ie, cs_t},  {vs_ier, cs_c},  {vs_ier, cs_m},
                          {vs_ier, cs_n},  {vs_ier, cs_ng}, {vs_ier, cs_p},   {vs_ier, cs_t},

                          {vs_oa, cs_c},   {vs_oa, cs_ch},  {vs_oa, cs_m},    {vs_oa, cs_n},   {vs_oa, cs_ng},  {vs_oa, cs_nh},  {vs_oa, cs_p},  {vs_oa, cs_t},   {vs_oab, cs_c},
                          {vs_oab, cs_m},  {vs_oab, cs_n},  {vs_oab, cs_ng},  {vs_oab, cs_t},

                          {vs_oe, cs_n},   {vs_oe, cs_t},

                          {vs_ua, cs_n},   {vs_ua, cs_ng},  {vs_ua, cs_t},    {vs_uar, cs_n},  {vs_uar, cs_ng}, {vs_uar, cs_t},

                          {vs_ue, cs_c},   {vs_ue, cs_ch},  {vs_ue, cs_n},    {vs_ue, cs_nh},  {vs_uer, cs_c},  {vs_uer, cs_ch}, {vs_uer, cs_n}, {vs_uer, cs_nh},

                          {vs_uo, cs_c},   {vs_uo, cs_m},   {vs_uo, cs_n},    {vs_uo, cs_ng},  {vs_uo, cs_p},   {vs_uo, cs_t},   {vs_uor, cs_c}, {vs_uor, cs_m},  {vs_uor, cs_n},
                          {vs_uor, cs_ng}, {vs_uor, cs_t},  {vs_uho, cs_c},   {vs_uho, cs_m},  {vs_uho, cs_n},  {vs_uho, cs_ng}, {vs_uho, cs_p}, {vs_uho, cs_t},  {vs_uhoh, cs_c},
                          {vs_uhoh, cs_m}, {vs_uhoh, cs_n}, {vs_uhoh, cs_ng}, {vs_uhoh, cs_p}, {vs_uhoh, cs_t},

                          {vs_uy, cs_c},   {vs_uy, cs_ch},  {vs_uy, cs_n},    {vs_uy, cs_nh},  {vs_uy, cs_p},   {vs_uy, cs_t},

                          {vs_ye, cs_m},   {vs_ye, cs_n},   {vs_ye, cs_ng},   {vs_ye, cs_p},   {vs_ye, cs_t},   {vs_yer, cs_m},  {vs_yer, cs_n}, {vs_yer, cs_ng}, {vs_yer, cs_t},

                          {vs_uye, cs_n},  {vs_uye, cs_t},  {vs_uyer, cs_n},  {vs_uyer, cs_t}
...
bool isValidCV(ConSeq c, VowelSeq v) {
    ...
    if (c == cs_k) {
        static VowelSeq kVseq[] = {vs_e, vs_i, vs_y, vs_er, vs_eo, vs_eu, vs_eru, vs_ia, vs_ie, vs_ier, vs_ieu, vs_ieru, vs_nil};
        int             i;
...
int UkEngine::processRoof(UkKeyEvent& ev) {
    ...
    VnLexiName target;
    switch (ev.evType) {
        case vneRoof_a: target = vnl_ar; break;
        case vneRoof_e: target = vnl_er; break;
        case vneRoof_o: target = vnl_or; break;
        default: target = vnl_nonVnChar;
    }
                ...
                if (v[1] == vnl_o || v[1] == vnl_or) {
                    ...
                    if ((vs == vs_uo || vs == vs_uor) && vEnd == m_current &&
                        ((m_buffer[m_current].form == vnw_cv &&
                          (m_buffer[m_current - 2].cseq == cs_h || m_buffer[m_current - 2].cseq == cs_kh || m_buffer[m_current - 2].cseq == cs_th)) ||
...
int UkEngine::processDd(UkKeyEvent& ev) {
    ...
    if (m_buffer[m_current].form == vnw_nonVn && m_buffer[m_current].vnSym == vnl_d &&
...
int UkEngine::checkEscapeVIQR(UkKeyEvent& ev) {
    ...
    if (entry.form == vnw_v || entry.form == vnw_cv) {
        switch (ev.keyCode) {
            case '^': escape = (entry.vnSym == vnl_a || entry.vnSym == vnl_o || entry.vnSym == vnl_e); break;
            case '(': escape = (entry.vnSym == vnl_a); break;
            case '+': escape = (entry.vnSym == vnl_o || entry.vnSym == vnl_u); break;
            case '\'':
            case '`':
            case '?':
            case '~':
            case '.': escape = (entry.tone == 0); break;
        }
    } else if (entry.form == vnw_nonVn) {
        unsigned char ch = toupper(entry.keyCode);
        switch (ev.keyCode) {
            case '^': escape = (ch == 'A' || ch == 'O' || ch == 'E'); break;
            case '(': escape = (ch == 'A'); break;
            case '+': escape = (ch == 'O' || ch == 'U'); break;
            case '\'':
            case '`':
            case '?':
            case '~':
            case '.': escape = (ch == 'A' || ch == 'E' || ch == 'I' || ch == 'O' || ch == 'U' || ch == 'Y'); break;
        }
    }
...
int UkEngine::processAppend(UkKeyEvent& ev) {
    ...
    switch (ev.chType) {
        case ukcReset:
            ...
            reset();
            return 0;
        case ukcWordBreak: m_singleMode = false; return processWordEnd(ev);
        case ukcNonVn: {
...
int UkEngine::appendVowel(UkKeyEvent& ev) {
    ...
    switch (prev.form) {
        ...
        case vnw_cv:
            ...
            // u+o/uo+ + u/i -> u+o+ + u/i
            if ((vs == vs_uoh || vs == vs_uho) && (lowerSym == vnl_i || lowerSym == vnl_u)) {
                if (vs == vs_uho) {
...
//----------------------------------------------------------
void UkEngine::rebuildChar(VnLexiName ch, int& backs, unsigned char* outBuf, int& outSize) {
    static const std::unordered_map<VnLexiName, UkKeyEvName> map{{vnl_Ar, vneRoof_a}, {vnl_Ab, vneBowl},   {vnl_DD, vneDd},    {vnl_Er, vneRoof_e},
                                                                 {vnl_Or, vneRoof_o}, {vnl_Oh, vneHook_o}, {vnl_Uh, vneHook_u}};
    ...
    // modify vowel
    auto it = map.find(noToneChar % 2 == 0 ? static_cast<VnLexiName>(noToneChar) : static_cast<VnLexiName>(noToneChar - 1));
    if (it != map.end()) {
        ev.evType = it->second;
...
int UkEngine::processBackspace(int& backs, unsigned char* outBuf, int& outSize, UkOutputType& outType) {
    ...
    if (m_current == 0 || m_buffer[m_current].form == vnw_empty || m_buffer[m_current].form == vnw_nonVn || m_buffer[m_current].form == vnw_c ||
        m_buffer[m_current - 1].form == vnw_c || m_buffer[m_current - 1].form == vnw_cvc || m_buffer[m_current - 1].form == vnw_vc) {
...
int UkEngine::macroMatch(UkKeyEvent& ev) {
    ...
    if (outSize < *m_pOutSize && ev.keyCode) {
        ...
        VnConvert(CONV_CHARSET_VNSTANDARD, m_pCtrl->charsetId, (UKBYTE*)&vnChar, ((UKBYTE*)m_pOutBuf) + outSize, &inLen, &maxOutSize);
        outSize += maxOutSize;
    }
...
bool UkEngine::lastWordIsNonVn() const {
    ...
    switch (m_buffer[m_current].form) {
        case vnw_nonVn: return true;
        case vnw_empty:
        case vnw_c: return false;
        case vnw_v:
        case vnw_cv: return !VSeqList[m_buffer[m_current].vseq].complete;
        case vnw_vc:
        case vnw_cvc: {
